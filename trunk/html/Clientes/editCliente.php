...
?>
	<form id="frm" action="<?php echo  $_SERVER['_SELF']?>" method="GET">
		<table >
			...
			<tr class="ListaTitulo">
				<td><?php echo  _translate("Tipo de empresa")?>:</td>
				<td class="impar">
			...
			<tr class="ListaTitulo">
				<td><?php echo  _translate("Grupo de empresas")?>:</td>
				<td class="impar">
			...
			<tr class="ListaTitulo">
				<td><?php echo  _translate("Número de empleados")?>:</td>
				<td class="impar">
			...
			<tr class="ListaTitulo">
				<td><?php echo  _translate("Norma implantada")?>:</td>
				<td class="impar">
			...
			<tr class="ListaTitulo">
				<td><?php echo  _translate("Créditos")?>:</td>
				<td class="impar">
