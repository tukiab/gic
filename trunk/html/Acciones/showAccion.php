...
<div align="center" style="margin-top:40px">
	<table class="ConDatos">
		...
		<tr>
			<td class="ColIzq" nowrap><?php echo  _translate("Tipo Acción")?>:</td>
			<td class="ColDer">
		...
		<tr>
			<td class="ColIzq" nowrap><?php echo  _translate("Fecha siguiente acción")?>:</td>
			<td class="ColDer">
				<?php  echo timestamp2date($var->opt['Accion']->get_Fecha_Siguiente_Accion())?>
			</td>
		</tr>
		<tr>
			<td class="ColIzq" nowrap><?php echo  _translate("Descipción")?>:</td>
