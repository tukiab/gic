<?/*
   ...
   */
	...
	//Graficas en general
	require_once ($appRoot.'/Common/imagenes/jpgraph-2.2/src/jpgraph.php');
	//para diagramas de barras
	require_once ($appRoot.'/Common/imagenes/jpgraph-2.2/src/jpgraph_bar.php');
	//polígonos triangulares
	require_once ($appRoot.'/Common/imagenes/jpgraph-2.2/src/jpgraph_line.php');
	require_once ($appRoot.'/Common/imagenes/jpgraph-2.2/src/jpgraph_log.php');
