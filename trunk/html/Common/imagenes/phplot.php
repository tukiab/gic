...
/**
 * Librería phplot original con algunos retoques para adaptarlo a las necesidades
 * de Common/imagenes/phplot_Stats.php
 */

/* $Id: phplot.php,v 1.95 2004/10/24 16:40:58 migueldb Exp $ */
...
/////////////////////////////////////////////
    ...
    function SetDefaultFonts(){
        ...
        if($this->use_ttf){
            ...
            $this->SetFont('legend', $this->default_ttfont, 6);
...
/////////////////////////////////////////////
    ...
    function DrawPieChart(){
        ...
        $diameter = min($this->plot_area_width-100, $this->plot_area_height-100);
        $radius = $diameter/2;
 
        $xpos = (($this->plot_area[0] + $this->plot_area_width)/2) + $radius/1.4;
