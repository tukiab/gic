...
include ($appRoot.'/include/html/popupHeader.php');
	...
	<div align="center">
	  <table style="margin-top:8ex;margin-left:2%;margin-right:2%;">
		...
		<tr>
			...
			<td>
				<input style="width:120px"  style="width:100%"  type="text" name="nombre_oferta" value="<?php echo  $var->opt['nombre_oferta'];?>" />
			</td>
	    </tr>
		<tr>
		  <td nowrap><?php echo  _translate("Estado")?>&#42;</td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="estado_oferta">
				<?php 
				$estado_oferta_seleccionado = $var->opt['estado_oferta'];?>
				<option value="0" <?php if(0 == $estado_oferta_seleccionado) echo  "selected:\"selected\"";?>><?php echo _translate("Elija una opción");?></option>	
	    ...
	    <tr>
		  <td nowrap><?php echo  _translate("Tipo de producto")?>&#42;</td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="producto">
				<?php 
				$producto_seleccionado = $var->opt['producto'];?>
				<option value="0" <?php if(0 == $producto_seleccionado) echo  "selected:\"selected\"";?>><?php echo _translate("Elija una opción");?></option>
	    ...
	    <tr>
		  <td nowrap><?php echo  _translate("Proveedor")?>&#42;</td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="proveedor">
				<?php 
				$proveedor_seleccionado = $var->opt['proveedor'];?>
				<option value="-1" <?php if(-1 == $producto_seleccionado) echo  "selected:\"selected\"";?>><?php echo _translate("Elija una opción");?></option>
		  ...
		  <td style="text-align: right;">
			<input style="width:98px"   type="text" class="fecha" name="fecha" value="<?php echo  timestamp2date($var->opt['fecha']);?>" />
		  </td>	
	    </tr>
	    <tr>
	      <td nowrap><?php echo  _translate("Importe")?>&#42;</td>
		  <td>
			<input style="width:120px"   type="text" name=importe value="<?php echo  $var->opt['importe'];?>" />&nbsp;&euro;
		  </td>	
	    </tr>
	    
	    <tr>
	      <td nowrap><?php echo  _translate("Fecha de definición")?>&#42;</td>
		  <td style="text-align: right;">
			<input style="width:98px"   type="text" class="fecha" name="fecha_definicion" value="<?php echo  timestamp2date($var->opt['fecha_definicion']);?>" />
		  </td>	
	    </tr>
	    <tr>
		  <td nowrap><?php echo  _translate("Probabilidad de contratación")?>&#42;</td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="probabilidad_contratacion">
				<?php 
				$probabilidad_seleccionado = $var->opt['probabilidad_contratacion'];?>
				<option value="0" <?php if(0 == $probabilidad_seleccionado) echo  "selected:\"selected\"";?>><?php echo _translate("Elija una opción");?></option>
	    ...
	    <tr>
		  <td nowrap><?php echo  _translate("Colaborador")?>&#42;</td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="colaborador">
				<?php 
				$colaborador_seleccionado = $var->opt['colaborador'];?>
				<option value="0" <?php if(0 == $colaborador_seleccionado) echo  "selected:\"selected\"";?>><?php echo _translate("Elija una opción");?></option>
	...
	<table>
		<tr>
	      <td nowrap><?php echo  _translate("Gestor que realiza la oferta")?></td>
		  <td>
