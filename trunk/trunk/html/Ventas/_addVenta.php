...
Puede acceder a la venta en GIC con el id de venta <b>'.$venta->get_Id().'</b> o accediendo <b><a target="_blank" href="http://'.$_SERVER['HTTP_HOST'].'/gic/html/Ventas/showVenta.php?id='.$venta->get_Id().'">aqu&iacute;</a></b>');
