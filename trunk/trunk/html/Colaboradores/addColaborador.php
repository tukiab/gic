...
<div id="contenedor" align="center">	
	...
	<?php } ?>
	  <table style="margin-top:0.2ex;margin-left:2%;margin-right:2%;">
	  	<tr>
		  <td class="ListaTitulo"  colspan="2"><?php echo  _translate("Datos del Colaborador")?></td>
		</tr>
		<tr>
		...
		<tr>
		  <td class="ColIzq"><?php echo  _translate("NIF")?></td>
		  <td class="ColDer">
	    ...
	    <tr>
	      <td class="ColIzq"><?php echo  _translate("Comisi&oacute;n (en %)")?>&#42;</td>
		  <td class="ColDer">
		  	<input type="text"  name="comision" value="<?php echo  $var->opt['comision'];?>" />
		  	
		  </td>	
	    </tr>
	    <tr>
	      <td class="ColIzq"><?php echo  _translate("Comisi&oacute;n por renovaci&oacute;n (en %)")?></td>
		  <td class="ColDer">
		  	<input  type="text"  name="comsion_por_renovacion" value="<?php echo  $var->opt['comsion_por_renovacion'];?>" />
		  </td>	
	    </tr>
	    <tr>
	      <td class="ColIzq"><?php echo  _translate("CC pago comisiones")?></td>
		  <td class="ColDer">
			<input    type="text" name="cc_pago_comisiones" value="<?php echo  $var->opt['cc_pago_comisiones'];?>" />
		  </td>	
	    </tr>	
	  </table>  
	 	<table style="margin-top:0.2ex;margin-left:2%;margin-right:2%;" id="contactos">
	  		<tr>
		    	<td colspan="6" class="ListaTitulo"  colspan="2"><?php echo  _translate("Otros contactos del colaborador")?></td>
			</tr>
			<tr>
