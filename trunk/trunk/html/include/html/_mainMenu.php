...
class MainMenu{
	...
	public function getUserMenu($user){
		...
		if($perfil_usuario['id'] == 5 || $perfil_usuario['id'] == 4){
			...
			$this->menus[5][0]= new Menu("#", "Informes +", "informes");
				$this->menus[5][1] = new Menu("$appDir/Acciones/reportsAcciones.php", "Acciones", "acciones");
				$this->menus[5][2] = new Menu("$appDir/Ofertas/reportsOfertas.php", "Ofertas", "ofertas");
				
			$this->menus[6][0]= new Menu("#", "Colaboradores +", "colaboradores");
				$this->menus[6][1]= new Menu("$appDir/Colaboradores/searchColaboradores.php", "Listado");
				$this->menus[6][2]= new Menu("$appDir/Colaboradores/addColaborador.php", "Nuevo");

			$this->menus[7][0]= new Menu("#", "Proveedores +", "proveedores");
				$this->menus[7][1]= new Menu("$appDir/Proveedores/searchProveedores.php", "B&uacute;squeda");
		...
		$this->menus[9] = new Menu("$appDir/Facturas/searchFacturas.php", "Facturas", "facturas");
