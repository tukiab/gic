...
include ($appRoot.'/Common/php/utils/_adjuntar_archivo.php');
			...
			<td style="vertical-align:top;">
				...
				<?if($var->datos['lista_archivos']){?>
					<?foreach($var->datos['lista_archivos'] as $Adjunto){?>
						<tr hover>
							<td class="impar" width="30%"><a href="javascript:void(0);" onClick="window.open('<?echo  $appDir.'/Common/php/utils/enviar_archivo.php?id='.$var->opt['id'].'&clase='.$var->opt['clase'].'&id_archivo='.$Adjunto->get_Id()?>','<?echo  rand()?>','width=700,height=350,scrollbars=yes');" ><?echo  $Adjunto->get_Name()?></a></td>
