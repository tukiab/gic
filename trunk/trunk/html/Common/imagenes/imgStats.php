<?  include ('../appRoot.php');
/**
 * Éste archivo hace de punto de entrada para generar una gráfica con Common/imagenes/php_stats.php.
 * Para los parámetros se utiliza la clase Common/php/utils/params.php.
 * 
 * 	<img src="<?echo  "/Common/imagenes/imgStats.php?opt=".objetoParams.sentParams();?>">
 * 
 ...
 */
	...
	include ($appRoot.'/Common/imagenes/phplot_Stats.php');
