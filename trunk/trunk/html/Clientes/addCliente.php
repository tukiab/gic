	  ...
	  <table style="margin-top:0.2ex;margin-left:2%;margin-right:2%;">
	    ...
	    <tr>
		  ...
		  <td  style="text-align:right;">
			<select style="width:120px" name="tipo_cliente">
				<?php $tipo_cliente_seleccionado = $var->opt['tipo_cliente'];?>
				<option value="0" <?php if($tipo_cliente_seleccionado == 0) echo "SELECTED"; ?>><?php echo _translate("Elegir una opción");?></option>
		...
		<tr>
		  <td nowrap><?php echo  _translate("Grupo")?></td>
		  <td  style="text-align:right;">
			<select style="width:120px" name="grupo_empresas">
				<?php 
				$grupo_empresas_seleccionado = $var->opt['grupo_empresas'];?>
				<option value="0" <?php if($grupo_empresas_seleccionado == 0) echo "SELECTED"; ?>><?php echo _translate("Elegir una opción");?></option>
	    ...
	    <tr>
	      <td nowrap><?php echo  _translate("Teléfono")?>&#42;</td>
		  <td style="text-align:right">
	    ...
	    <tr>
	      <td nowrap><?php echo  _translate("FAX")?></td>
		  <td style="text-align:right">
		  	<input style="width:100%" type="text"  name="FAX" value="<?php echo  $var->opt['FAX'];?>" />
		  </td>	
	    </tr>
	    <tr>
	      <td nowrap><?php echo  _translate("Número de empleados")?></td>
		  <td >
